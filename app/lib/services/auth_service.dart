...
///
/// O [http.Client] é injetável para testes.
class AuthService {
  ...
  Future<void> register({
    ...
    throw ApiException(
      'Não foi possível registrar (${response.statusCode}).',
  ...
  Future<AuthSession> login({
    ...
    throw ApiException(
      'Não foi possível entrar (${response.statusCode}).',
      statusCode: response.statusCode,
    );
  }
  ...
  Future<AuthUser> updateMe(
    ...
    throw ApiException(
      'Erro ao salvar perfil (${response.statusCode}).',
      statusCode: response.statusCode,
    );
  }
