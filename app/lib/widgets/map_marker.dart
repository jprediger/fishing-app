...
enum MapMarkerKind {
  ...
  catchRecord(AppColors.markerCatch, Icons.phishing),
...
class MapMarker extends StatelessWidget {
  ...
  const MapMarker({super.key, required this.kind, this.selected = false});
          ...
          child: Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: cs.shadow.withValues(alpha: selected ? 0.4 : 0.3),
              ...
              child: Icon(kind.icon, color: Colors.white, size: diameter * 0.5),
            ),
          ),
        ),
      ),
