...
public record FishRequestDTO(
    ...
    @Schema(description = "Nome da espécie", example = "Tucunaré")
    @NotBlank(message = "O nome é obrigatório")
    String name,

    @Schema(description = "Descrição da espécie", example = "Peixe predador de água doce, popular na pesca esportiva")
    String description,

    @Schema(description = "Região onde é encontrado", example = "Bacia Amazônica")
    String region,
    ...
    @Schema(description = "Ícone respectivo do peixe")
