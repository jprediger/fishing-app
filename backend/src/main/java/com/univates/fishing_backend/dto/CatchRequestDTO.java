...
public record CatchRequestDTO(
    @Schema(description = "Water body id")
    @NotNull(message = "Water body is required")
    Long waterBodyId,

    @Schema(description = "Exact catch location")
    @NotNull(message = "Location is required")
    @Valid
    LocationDTO location,

    @Schema(description = "Public location visibility")
    @NotNull(message = "Location visibility is required")
    ...
    @NotNull(message = "Fishing method is required")
    FishingMethod fishingMethod,

    @NotNull(message = "Purpose is required")
    FishingPurpose purpose,

    @NotNull(message = "Caught at is required")
