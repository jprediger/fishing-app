...
class WaterBodyRepositoryIntegrationTest {
    ...
    void findNearest_returnsClosestWaterBodyInsideRadius() {
        insertWaterBody(1L, "Rio A", "RIVER",
            "LINESTRING(-51.30 -30.10, -51.20 -30.08)", 1001L);
        insertWaterBody(2L, "Rio B", "RIVER",
            "LINESTRING(-52.10 -31.10, -52.00 -31.00)", 1002L);
    ...
    void findInBbox_returnsBodiesInsideViewport() {
        insertWaterBody(1L, "Rio A", "RIVER",
            "LINESTRING(-51.30 -30.10, -51.20 -30.08)", 1001L);
        insertWaterBody(2L, "Lago B", "LAKE",
            "POLYGON((-51.10 -30.20, -51.00 -30.20, -51.00 -30.10, -51.10 -30.10, -51.10 -30.20))",
            1002L);

        var result = waterBodyRepository.findInBbox(
            -51.40,
            -30.30,
            -50.90,
            -30.00,
